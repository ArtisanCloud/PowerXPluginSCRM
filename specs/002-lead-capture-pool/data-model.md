...
- phone (text)
- email (text)
- status (varchar: captured/enriched/deduplicated/routed/engaging/qualified_for_handoff/handoff_pending/handoff_accepted/handoff_failed/archived/disconnected)
...
- Status machine: captured -> enriched -> deduplicated -> routed -> engaging -> qualified_for_handoff -> handoff_pending -> handoff_accepted
- Failure/recovery: handoff_pending -> handoff_failed -> handoff_pending
- Archive: captured/enriched/deduplicated/routed/engaging/qualified_for_handoff/handoff_failed -> archived
