...
- Go 1.24（backend）, TypeScript 4 + Nuxt 4（web-admin） + Gin, GORM, PowerWechat SDK, Nuxt UI 3.3.x, Pinia (004-wecom-lead-managment)
- PostgreSQL（主存储，租户隔离/RLS），Redis（可选缓存/队列） (004-wecom-lead-managment)
...
## Recent Changes
- 004-wecom-lead-managment: Added Go 1.24（backend）, TypeScript 4 + Nuxt 4（web-admin） + Gin, GORM, PowerWechat SDK, Nuxt UI 3.3.x, Pinia
