...
func RBACEntries(prefix string) map[string]authx.Permission {
	...
	return map[string]authx.Permission{
		...
		"GET:" + base + "/:lead_id/timeline":                                                     {Resource: "scrm.leads", Action: "read"},
		"POST:" + base + "/:lead_id/activities":                                                  {Resource: "scrm.leads", Action: "write"},
		"GET:" + base + "/:lead_id/node-attachments":                                             {Resource: "scrm.leads", Action: "read"},
		"POST:" + base + "/:lead_id/node-attachments":                                            {Resource: "scrm.leads", Action: "write"},
		"GET:" + base + "/:lead_id/activities/:activity_id/attachments":                          {Resource: "scrm.leads", Action: "read"},
		"POST:" + base + "/:lead_id/activities/:activity_id/attachments":                         {Resource: "scrm.leads", Action: "write"},
		"GET:" + base + "/:lead_id/attachments/:attachment_id/download":                          {Resource: "scrm.leads", Action: "read"},
		"DELETE:" + base + "/:lead_id/attachments/:attachment_id":                                {Resource: "scrm.leads", Action: "write"},
