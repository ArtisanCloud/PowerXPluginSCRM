...
func RBACEntries(prefix string) map[string]authx.Permission {
	...
	return map[string]authx.Permission{
		...
		"GET:" + base + "/forecast":                                                    {Resource: "scrm.opportunity", Action: "read"},
		"GET:" + base + "/pipeline/default":                                            {Resource: "scrm.opportunity", Action: "read"},
		"GET:" + base + "/pipeline-templates":                                          {Resource: "scrm.opportunity", Action: "read"},
		"GET:" + base + "/pipeline-groups":                                             {Resource: "scrm.opportunity", Action: "read"},
		"POST:" + base + "/pipeline-groups":                                            {Resource: "scrm.opportunity", Action: "write"},
		"GET:" + base + "/pipeline-groups/:group_uuid":                                 {Resource: "scrm.opportunity", Action: "read"},
		"GET:" + base + "/stage-configs":                                               {Resource: "scrm.opportunity", Action: "read"},
		"PUT:" + base + "/stage-configs/:stage_key":                                    {Resource: "scrm.opportunity", Action: "write"},
		...
		"GET:" + base + "/records/:opportunity_uuid/duplicates":                        {Resource: "scrm.opportunity", Action: "read"},
		"POST:" + base + "/records/:opportunity_uuid/merge":                            {Resource: "scrm.opportunity", Action: "write"},
		...
		"PATCH:" + base + "/records/:opportunity_uuid/line-items/:item_uuid/approval":  {Resource: "scrm.opportunity", Action: "write"},
		"DELETE:" + base + "/records/:opportunity_uuid/line-items/:item_uuid":          {Resource: "scrm.opportunity", Action: "write"},
		"GET:" + base + "/records/:opportunity_uuid/contracts":                         {Resource: "scrm.opportunity", Action: "read"},
		"POST:" + base + "/records/:opportunity_uuid/contracts":                        {Resource: "scrm.opportunity", Action: "write"},
		"PATCH:" + base + "/records/:opportunity_uuid/contracts/:contract_uuid/status": {Resource: "scrm.opportunity", Action: "write"},
		"GET:" + base + "/records/:opportunity_uuid/payments":                          {Resource: "scrm.opportunity", Action: "read"},
		"POST:" + base + "/records/:opportunity_uuid/payments":                         {Resource: "scrm.opportunity", Action: "write"},
		"PATCH:" + base + "/records/:opportunity_uuid/payments/:payment_uuid/status":   {Resource: "scrm.opportunity", Action: "write"},
