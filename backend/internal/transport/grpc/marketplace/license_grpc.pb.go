...
const (
	LicenseService_Issue_FullMethodName  = "/marketplace.LicenseService/Issue"
	LicenseService_Renew_FullMethodName  = "/marketplace.LicenseService/Renew"
	LicenseService_Verify_FullMethodName = "/marketplace.LicenseService/Verify"
)
...
type LicenseServiceClient interface {
	Issue(ctx context.Context, in *IssueLicenseRequest, opts ...grpc.CallOption) (*IssueLicenseResponse, error)
	Renew(ctx context.Context, in *RenewLicenseRequest, opts ...grpc.CallOption) (*RenewLicenseResponse, error)
	Verify(ctx context.Context, in *VerifyLicenseRequest, opts ...grpc.CallOption) (*VerifyLicenseResponse, error)
}
...
func (c *licenseServiceClient) Issue(ctx context.Context, in *IssueLicenseRequest, opts ...grpc.CallOption) (*IssueLicenseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IssueLicenseResponse)
	err := c.cc.Invoke(ctx, LicenseService_Issue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *licenseServiceClient) Renew(ctx context.Context, in *RenewLicenseRequest, opts ...grpc.CallOption) (*RenewLicenseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RenewLicenseResponse)
	err := c.cc.Invoke(ctx, LicenseService_Renew_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *licenseServiceClient) Verify(ctx context.Context, in *VerifyLicenseRequest, opts ...grpc.CallOption) (*VerifyLicenseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyLicenseResponse)
	err := c.cc.Invoke(ctx, LicenseService_Verify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LicenseService_Issue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LicenseService_Issue_FullMethodName,
	}
...
func _LicenseService_Renew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LicenseService_Renew_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LicenseService_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LicenseService_Verify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var LicenseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "marketplace.LicenseService",
	...
	Metadata: "internal/transport/grpc/marketplace/license.proto",
}
