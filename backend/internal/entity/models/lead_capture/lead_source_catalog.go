...
// LeadSourceCatalog stores global dictionary items for lead traffic attribution.
type LeadSourceCatalog struct {
	...
	Category    string    `gorm:"column:category;type:varchar(128);not null;index:idx_lead_capture_source_catalogs_category;uniqueIndex:uq_lead_capture_source_catalogs_category_code,priority:1" json:"category"`
	Code        string    `gorm:"column:code;type:varchar(64);not null;uniqueIndex:uq_lead_capture_source_catalogs_category_code,priority:2" json:"code"`
