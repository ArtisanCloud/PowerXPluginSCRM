...
onMounted(() => {
  setupHostBridgeAdapter({
    debug: true,
    pluginId: "com.powerx.plugins.scrm",
    instanceId: "dev-bridge",
  });
});
...
<i18n lang="json">
{
  "zh": {
    "demo": {
      "title": "插件演示页（随宿主切换语言/主题）",
      "body": "请从 /bridge-dev/parent 切换语言/主题，这里会立即生效。"
    }
  },
  "en": {
    "demo": {
      "title": "Plugin Demo (reacts to host locale/theme)",
      "body": "Use /bridge-dev/parent to switch locale/theme, changes apply here instantly."
    }
  }
}
</i18n>
