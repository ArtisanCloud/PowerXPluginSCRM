...
<template>
  <div>
    ...
    <div class="mb-6">
      ...
      <!-- 租户选择器 -->
      <div
        class="bg-white p-4 rounded-lg shadow-sm dark:bg-slate-950/70 dark:border dark:border-slate-800/60"
      >
        <div class="flex items-center gap-4">
          ...
          <div v-if="selectedTenant" class="flex-1">
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm text-gray-500 dark:text-slate-200">
    ...
    <div class="rounded-lg bg-white shadow-sm dark:bg-slate-950/70 dark:border dark:border-slate-800/60">
      ...
      <div
        ...
        class="text-center py-12 text-gray-500 dark:text-slate-300"
      >
        <UIcon
          name="i-heroicons-users"
          class="h-12 w-12 mx-auto mb-4 text-gray-300 dark:text-slate-600"
        />
    ...
    <!-- 权限说明 -->
    <div
      class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg dark:bg-slate-900/60 dark:border-slate-800/70"
    >
      <div class="flex items-start">
        <UIcon
          name="i-heroicons-information-circle"
          class="h-5 w-5 text-blue-600 dark:text-blue-200 mt-0.5 mr-3 flex-shrink-0"
        />
        <div class="text-sm">
          <p class="font-medium text-blue-800 dark:text-slate-100 mb-1">
            权限说明
          </p>
          <ul class="text-blue-700 dark:text-slate-200 space-y-1">
