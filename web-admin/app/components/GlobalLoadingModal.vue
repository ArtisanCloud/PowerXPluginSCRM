...
const LogoUrl = "/images/logo-m.png";
      ...
      >
        ...
        <div class="relative z-10 h-full flex flex-col items-center justify-center">
          <div class="relative w-32 h-32 mb-12">
            ...
            ></div>
            <div class="absolute inset-3 w-26 h-26 flex items-center justify-center">
              <img
                :src="LogoUrl"
                alt="PowerX Logo"
          ...
          <div class="text-center space-y-4 mb-8">
            ...
            <div v-if="isProgressMode" class="text-center">
              <span
                ...
                :class="[isDark ? 'text-purple-200 drop-shadow-lg' : 'text-purple-600']"
              >
                {{ progressValue }}%
              </span>
            </div>
...
.animate-bounce-1 {
  animation: bounce-1 1.2s ease-in-out infinite;
}
.animate-bounce-2 {
  animation: bounce-2 1.2s ease-in-out infinite 0.15s;
}
.animate-bounce-3 {
  animation: bounce-3 1.2s ease-in-out infinite 0.3s;
}
.animate-fade-in {
